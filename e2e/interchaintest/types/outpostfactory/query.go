...
type QueryClient interface {
	// GetCallbackCount is the client API for the QueryMsg_GetCallbackCount query message
	GetCallbackCount(ctx context.Context, req *QueryMsg_GetCallbackCount, opts ...grpc.CallOption) (*int, error)
	...
	// GetUserOutpostAddress is the client API for the QueryMsg_GetUserOutpostAddress query message
	GetUserOutpostAddress(ctx context.Context, req *QueryMsg_GetUserOutpostAddress, opts ...grpc.CallOption) (*string, error)
}
...
func (q *queryClient) GetUserOutpostAddress(ctx context.Context, req *QueryMsg_GetUserOutpostAddress, opts ...grpc.CallOption) (*string, error) {
	rawQueryData, err := json.Marshal(&QueryMsg{GetUserOutpostAddress: req})
	if err != nil {
		return nil, err
	}
...
func (q *queryClient) GetCallbackCount(ctx context.Context, req *QueryMsg_GetCallbackCount, opts ...grpc.CallOption) (*int, error) {
	rawQueryData, err := json.Marshal(&QueryMsg{GetCallbackCount: req})
	if err != nil {
		return nil, err
	}
